...
export const MATERIAL_SEARCH_NAMES = {
  ...
  // 강화 관련 추가 재료들 (EnhancementCalculator용)
  '용암의 숨결': '용암의 숨결',
  '빙하의 숨결': '빙하의 숨결',
  '야금술 : 업화 [11-14]': '야금술 : 업화 [11-14]',
  '야금술 : 업화 [15-18]': '야금술 : 업화 [15-18]',
  '야금술 : 업화 [19-20]': '야금술 : 업화 [19-20]',
  '재봉술 : 업화 [11-14]': '재봉술 : 업화 [11-14]',
  '재봉술 : 업화 [15-18]': '재봉술 : 업화 [15-18]',
  '재봉술 : 업화 [19-20]': '재봉술 : 업화 [19-20]',
  '장인의 야금술 : 1단계': '장인의 야금술 : 1단계',
  '장인의 야금술 : 2단계': '장인의 야금술 : 2단계',
  '장인의 재봉술 : 1단계': '장인의 재봉술 : 1단계',
  '장인의 재봉술 : 2단계': '장인의 재봉술 : 2단계'
};
