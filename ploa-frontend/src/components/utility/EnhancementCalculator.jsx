...
import { Search, Loader2, Clock, X, Plus, Minus } from 'lucide-react';
...
const EnhancementCalculator = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 재료 옵션 */}
      {equipmentData && (
        <div className="flex items-center gap-6 p-3 bg-gray-50 dark:bg-gray-800 rounded text-sm">
      ...
      {equipmentData && (
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded text-sm">
            <div className="font-medium text-green-800 dark:text-green-400 mb-1">운 좋음</div>
            <div className="text-green-700 dark:text-green-300">계산 중...</div>
          </div>
          <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded text-sm">
            <div className="font-medium text-red-800 dark:text-red-400 mb-1">운 나쁨</div>
            <div className="text-red-700 dark:text-red-300">계산 중...</div>
          </div>
        </div>
      )}
    </div>
